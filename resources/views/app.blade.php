        ...
        <div class="container mx-auto">
            <div class="flex flex-wrap -mx-4">
                <div class="w-full px-4 sm:w-2/3 lg:w-3/12">
                    <div class="w-full mb-10">
                        <a href="javascript:void(0)" class="mb-6 inline-block max-w-[160px]">
                            <img src="assets/images/logo/logo.svg" alt="logo" class="max-w-full dark:hidden" />
                            <img src="assets/images/logo/logo-white.svg" alt="logo"
                                class="hidden max-w-full dark:block" />
                        </a>
                        <p class="text-base mb-7 text-body-color dark:text-dark-6">
                ...
                <div class="w-full px-4 sm:w-1/2 lg:w-2/12">
                    <div class="w-full mb-10">
                        <h4 class="text-lg font-semibold mb-9 text-dark dark:text-white">
                            Resources
                        </h4>
                        <ul class="space-y-3">
                            <li>
                ...
                <div class="w-full px-4 sm:w-1/2 lg:w-3/12">
                    <div class="w-full mb-10">
                        ...
                        <div class="flex items-center mb-6">
                            <a href="javascript:void(0)"
                                class="flex items-center justify-center w-8 h-8 mr-3 border rounded-full border-stroke text-dark hover:border-primary hover:bg-primary hover:text-white dark:border-dark-3 dark:text-white dark:hover:border-primary sm:mr-4 lg:mr-3 xl:mr-4">
