<section class="relative z-10 overflow-hidden bg-white py-20 dark:bg-dark lg:py-[120px]">
            ...
            <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
                <div class="relative p-8 bg-white rounded-lg shadow-lg dark:bg-dark-2 sm:p-12">
                    <form wire:submit='submit'>
                        ...
                        <div>
                            <button type="submit"
                                class="w-full p-3 text-black transition border rounded border-primary bg-primary hover:bg-opacity-90">
                                Send Message
                            </button>
                        </div>
                    </form>
